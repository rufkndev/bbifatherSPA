...
• <i>Стандартное время:</i> до 7 дней с момента получения оплаты
• <i>Сложные случаи:</i> при больших объемах или непредвиденных обстоятельствах - до 2 недель
• <i>Срочные заказы (1-2 дня):</i> выполняются с 25% прибавкой к стоимости и обговариваются с администратором

<b>🔧 3. Исправления:</b>
• <b>1 бесплатная правка</b> по каждой практической работе
• Стоимость последующих правок оценивается индивидуально
• ⚠️ <i>Все обсуждения и уточнения по исправлениям ведутся исключительно студентом</i>

<b>🛡️ 4. Гарантии:</b>
✅ Подробные объяснения по содержанию работы
✅ Ответы на вопросы по выполненной работе  
✅ Предоставление исходных материалов по запросу
✅ При написании кода - полные комментарии и объяснение логики

<b>📞 Поддержка:</b>
Обращайтесь по любым вопросам через "💬 Техподдержка"
        """
